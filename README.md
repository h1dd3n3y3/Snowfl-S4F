...
- A <ins>**_Bittorrent client_**</ins> is <ins>**_required_**</ins> _(duh...)_: [**_qBittorrent_**](https://www.fosshub.com/qBittorrent.html){:target="_blank"} is recommended, as **_more feature-focused_**, but everything else is fine _(€$£)_.  
